...
%     flexibleModeFrequency = flexibleModeFrequencySamples(i);
%         
%     modalControlAndModelStateSpace = generateStateSpaceFromSimulink(SIMULATION_VALIDATION_MODEL_WITH_MODAL_CONTROLLER_SIMULINK_FN);
%     plot(eig(modalControlAndModelStateSpace.system), '*');
% end
% xline(0,'-');
